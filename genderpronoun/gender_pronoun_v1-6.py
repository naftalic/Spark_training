"""
Example solution to week 4 peer assessment for Spark 1.6
Edit as required.
"""
...
if __name__ == "__main__":
    ...
    # create an sql context (entry point to spark sql)
    ...
    df2 = sqlContext.sql("SELECT DISTINCT id, title, author FROM pgcat WHERE lang='en'")
